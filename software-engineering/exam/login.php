    ...
    <body>
        ...
        <main id="page" class="container">
            <div class="w-50 position-absolute top-50 start-50 translate-middle">
                ...
                <!-- TODO: clean up-->
                <br>
                <p class="mt-3 position-absolute start-50 translate-middle warning">"Guest" level access (view only): Enter the logbook username without entering a password</p>
                <br>
                <br>
                <p class="mt-3 position-absolute start-50 translate-middle warning">"User" level access (view and edit): Enter the logbook username and password</p>
                <br>
                <br>
                <div id="usernames">
